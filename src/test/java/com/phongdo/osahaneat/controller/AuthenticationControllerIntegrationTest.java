...
public class AuthenticationControllerIntegrationTest {
    ...
    void initData() {
        ...
        Role roleUser = Role.builder().name(roleName).description("User role").build();
    ...
    void createUser_validRequest_success() throws Exception {
        ...
        // When, Then
        var response = mockMvc.perform(MockMvcRequestBuilders.post("http://localhost:8080/auth/signup")
